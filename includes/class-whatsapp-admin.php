...
class WhatsApp_Admin
{
    ...
    {
        check_ajax_referer('whatsapp_flotante_nonce', 'nonce');
    ...
    public function handle_form_submission()
    {
        ...
        if (
            ...
            !wp_verify_nonce($_POST['whatsapp_flotante_nonce'], 'whatsapp_flotante_save')
        ) {
        ...
        $icon_position = isset($_POST['icon_position']) ? $_POST['icon_position'] : 'bottom-right';
        ...
        $margin_bottom_unit = isset($_POST['margin_bottom_unit']) ? $_POST['margin_bottom_unit'] : 'px';
        $this->settings->save_margin_bottom_unit($margin_bottom_unit);

        $margin_side_unit = isset($_POST['margin_side_unit']) ? $_POST['margin_side_unit'] : 'px';
        ...
        $margin_bottom_unit_tablet = isset($_POST['margin_bottom_unit_tablet']) ? $_POST['margin_bottom_unit_tablet'] : 'px';
        $this->settings->save_margin_bottom_unit_tablet($margin_bottom_unit_tablet);

        $margin_side_unit_tablet = isset($_POST['margin_side_unit_tablet']) ? $_POST['margin_side_unit_tablet'] : 'px';
        ...
        $margin_bottom_unit_mobile = isset($_POST['margin_bottom_unit_mobile']) ? $_POST['margin_bottom_unit_mobile'] : 'px';
        $this->settings->save_margin_bottom_unit_mobile($margin_bottom_unit_mobile);

        $margin_side_unit_mobile = isset($_POST['margin_side_unit_mobile']) ? $_POST['margin_side_unit_mobile'] : 'px';
